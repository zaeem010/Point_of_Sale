        ...
        for (var i = 0; i < data.length; i++) {
            ...
            producthtmlstring += `<div class="col-xl-3">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <input type="number" id="customprice_${data[i].id}" value="${data[i].salePrice}" class="form-control" style="background:white;height:45px" />
                                    </div>
                                    <div class="btn-group">
                                        <input type="number" id="customval_${data[i].id}" class="form-control" value="1" style="background:white;height:45px" autofocus />
                                        <button type="button" onclick="AddtocartManPrice(this);" class="btn btn-primary" categoryId="${data[i].categoryId}" currentstock="${data[i].currentStock}" productname="${data[i].name}" id="${data[i].id}"><i class="fa fa-check"></i></button>
                                    </div>
                                </div>`;
        }
    } else {
...
//Add to cart Manual qty and price
function AddtocartManPrice(val) {
    let ProId = val.id;
    let Qty = parseInt($('#customval_' + ProId).val());
    let saleprice = parseInt($('#customprice_' + ProId).val());
