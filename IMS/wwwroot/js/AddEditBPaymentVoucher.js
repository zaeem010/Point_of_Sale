...
function Save()
{
    ...
    let Mytransdesc = "(" + Bank_Name +") Against Bank Payment Voucher No " + GeneralId + " And Date was " + VoucherDate;
    //table data
        ...
        success: function (data) {
            if (data != null) {
                ...
                if (data.message == "Updated Successfully") {
                    window.location.replace("/Bank-Payment/Bank-Paid-Detail/");
                }
            }
        }
    });
