...
function Save()
{
    ...
    let Mytransdesc = "(Cash) Against Cash Payment Voucher No " + GeneralId + " And Date was " + VoucherDate;
    //table data
        ...
        success: function (data) {
            if (data != null) {
                ...
                if (data.message == "Updated Successfully") {
                    window.location.replace("/Cash-Payment/Cash-Paid-Detail/");
                }
            }
        }
    });
